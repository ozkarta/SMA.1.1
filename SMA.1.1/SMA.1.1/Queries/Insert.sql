...
values  (@en,newid(),'home','Home'),
		...
		(@en,newid(),'resigtration_type','Registration Type'),
		...
		(@en,newid(),'registration_passwprd','Password'),
		(@en,newid(),'registration_confirm_passwprd','Confirm Password'),
		...
		(@ge,newid(),'registration_passwprd',N'პაროლი'),
		(@ge,newid(),'registration_confirm_passwprd',N'დაადასტურეთ პაროლი'),
